// Chunk fragment shader: unlit atlas texture x baked vertex light x the
// day/night cycle's global brightness, with alpha cutout (leaves/glass),
// water translucency, and distance fog toward the sky color. The vertex
...
fn fragment(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let lit = color.rgb * in.color.rgb * params.sky_light;
